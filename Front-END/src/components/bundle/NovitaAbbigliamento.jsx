              ...
              <div className="my-4">
                ...
                >
                  <div className="image-container">
                    <img
                      src="src\assets\imgMyProtein01.webp"
                      alt="img Product"
                    />
                  ...
                  <div className="text-start my-2">
                    <h5 style={{ fontSize: "1rem", fontWeight: "400" }}>
                      Crop top a costine senza cuciture MP Tempo da donna -
                      Lilla acceso
                    </h5>
            ...
            <div class="col">
              ...
              <div className="my-4">
                ...
                >
                  ...
                  <div className="text-start my-2">
                    <h5 style={{ fontSize: "1rem", fontWeight: "400" }}>
                      Leggings a costine senza cuciture MP Tempo da donna -
                      Lilla acceso
                    </h5>
          ...
          <div class="col">
            ...
            <div className="d-flex flex-column mt-5 gap-1 mediaLogo4 d-flex justify-content-center align-items-center">
              ...
              <img
                ...
                width={"150px"}
              />
              <p>Scarica l'App di Myprotein</p>
            </div>
          </div>
        </div>
      </div>
